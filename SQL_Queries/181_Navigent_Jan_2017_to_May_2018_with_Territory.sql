...
and cast(SHIP_VALIDATE_DATE as date) < '2018-06-01'				
	) src			
where rn =1				
...
select  				
 distinct				
 UnitNumber,CollectionDate,cast(NULL  as date) AS  [DiscardDate], cast(NULL as varchar) as DiscardReason,				
...
and  cast(SHIP_VALIDATE_DATE as date) >='2017-01-01' and cast(SHIP_VALIDATE_DATE as date) < '2018-06-01'				
	='W036817751235'			
)				
...
from				
(				
  select UnitNumber,CollectionDate,DiscardDate,DiscardReason,ShippedDate,CustomerName,ProductGroup,ProductCode,Product, product_inventory_id,reference_product_inv_id,ISBTCode,ORDER_ID,ReturnDateKey,				
...
sh.UnitNumber,sh.CollectionDate,cast(NULL  as date) AS  [DiscardDate],				
...
and  ship.product_inventory_id = ret.product_inventory_id				
where ret.return_Date >='2017-01-01' and	  ret.return_date <'2018-06-01'			
...
select  Unitnumber,CollectionDate,DiscardDate,Discardreason,ShippedDate,CustomerName,ProductGroup,ProductCode,Product,Product_Inventory_ID,Order_ID,Disposition,Step,TransactionDate,returnstatus 				
from work.dbo.Ship_Ret_Dis_Territory 				
order by Order_ID,Step,TransactionDate,CustomerName				
...
a.CustomerName				
,ProductGroup				
,isnull(Territory,'Not Available') Territory				
,disposition as Disposition,				
step,				
count(1) as [Count]				
from work.dbo.Ship_Ret_Dis_Territory a				
left join (select * from INTEGRATION.dbo.[INT_DIMCustomer] where source='RSA' and enddate is null) cust on cust.CustomerName=a.CustomerName 				
group by				
TransactionDate, 				
a.CustomerName,				
ProductGroup				
