...
update  final				
	...
	select UnitNumber,FORMAT(cast(CollectionDate as Date) ,'MM/dd/yyyy') CollectionDate,			
	FORMAT(cast(ShippedDate as Date),'MM/dd/yyyy') ShippedDate,CustomerName,			
	FORMAT(cast(DiscardDate as Date),'MM/dd/yyyy') DiscardDate,	DiscardReason,		
